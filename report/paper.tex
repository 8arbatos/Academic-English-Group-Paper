...
\begin{itemize}
    \item \textbf{For low-storage, offline applications:} Implicit methods (D-NeRF) remain a strong candidate due to their extreme compactness.
    \item \textbf{For real-time applications:} Explicit methods (4D-GS) are currently the only viable option for high-resolution ($>1080$p) real-time rendering.
    \item \textbf{For balanced needs:} Hybrid representations offer a middle ground, providing faster training than pure NeRFs with manageable storage costs.
\end{itemize}
...
\begin{itemize}
    ...
    \begin{enumerate}
        \item \textbf{Text-to-4D:} Combining text-to-video models with Dynamic 3DGS to generate 4D assets directly from prompts. The explicit nature of Gaussians makes them easier to manipulate than implicit NeRFs.
        \item \textbf{4D Editing:} Using generative diffusion models to stylize or edit reconstructed 4D scenes (e.g., changing the weather in a captured dynamic video) while maintaining temporal consistency.
    \end{enumerate}
\end{itemize}
...
\begin{thebibliography}{1}
  ...
  \bibitem{tineuvox}
  Jiemin Fang, Taoran Yi, Xinggang Wang, Lingxi Xie, Xiaopeng Zhang, Wenyu Liu, Matthias Nießner, and Qi Tian,
  ``Fast Dynamic Radiance Fields with Time-Aware Neural Voxels,''
  {\it{arXiv preprint}}, arXiv:2205.15285, 2022.
  [Online]. Available: https://arxiv.org/abs/2205.15285

  \bibitem{hexplane}
  Ang Cao, and Justin Johnson,
  ``HexPlane: A Fast Representation for Dynamic Scenes,''
  {\it{arXiv preprint}}, arXiv:2301.09632, 2023.
  [Online]. Available: https://arxiv.org/abs/2301.09632
\end{thebibliography}
